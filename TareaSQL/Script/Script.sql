...
--ejercicio2
 ...
 insert into agenda (apellido, nombre, domicilio, telefono)
  values ('Katiana','Monroe','Delmas','4230167');
 insert into agenda (apellido,nombre, domicilio, telefono)
  values ('Sophia','Ticoiny','P.v 200','4958787');
 ...
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('Trasnportador','Jason Statham',128,3);
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('Mision imposible 2','Tom Cruise',130,2);
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('OnG Back','Tonny jaa',118,3);
 insert into peliculas (nombre, actor, duracion, cantidad)
  values ('Avengers','MArvel',110,2);
 ...
 insert into peliculas (titulo, actor, duracion, cantidad)
  values ('Transportador','Jason STatham',180,3);
 insert into peliculas (titulo, actor, duracion, cantidad)
  values ('Mision imposible 2','Tom Cruise',190,2);
 insert into peliculas (titulo, actor, duracion, cantidad)
  values ('OnG Back','Tonny jaa',118,3);
 insert into peliculas (titulo, actor, duracion, cantidad)
  values ('Avangers','Marvel',110,2);
 ...
 insert into agenda(apellido,nombre,domicilio,telefono) values
  ('Jerryson', 'Lafleur', 'delmas 63', '4234567');

 insert into agenda(apellido,nombre,domicilio,telefono) values
  ('Antoine', 'pierre', 'carre four', '4458787');

 insert into agenda(apellido,nombre,domicilio,telefono) values
  ('Lopez', 'Etienne', 'ensanche Aguilar', '4887788'); 
 insert into agenda(apellido,nombre,domicilio,telefono) values
  ('Cacas', 'Pierre', 'delmas 32', '4545454');
 insert into agenda(apellido,nombre,domicilio,telefono) values
  ('Cendy', 'julia', 'Urquiza 333', '4545454');
 ...
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
  values (1,'Monitor','Samsung',400.80,20);
 insert into articulos (codigo, nombre, descripcion, precio,cantidad)
 ...
 insert into agenda (apellido,nombre,domicilio,telefono)
   values('Alisha','Aly','washinton','4234567');
 insert into agenda (apellido,nombre,domicilio,telefono)
   values('James','pierre','Florida','4458787');
 insert into agenda (apellido,nombre,domicilio,telefono)
   values('Lovely','Monroe','Usann 3','4545454');
 insert into agenda (apellido,nombre,domicilio,telefono)
   values('Louven','Jean','Delmas 32','4545454');
 insert into agenda (apellido,nombre,domicilio,telefono)
   values('Salas','Soine','Carre four','4123456');
 ...
 insert into agenda (apellido,nombre,domicilio,telefono)
  values ('Alisha','Aly','washington','4234567');
 insert into agenda (apellido,nombre,domicilio,telefono)
  values ('James','pierre','Florida','4458787');
 insert into agenda (apellido,nombre,domicilio,telefono)
  values ('Lovely','Monroe','Usann 3','4545454');
 insert into agenda (apellido,nombre,domicilio,telefono)
  values ('Louvens','Jose','Delmas 32','4545454');
 insert into agenda (apellido,nombre,domicilio,telefono)
  values ('Salas','Soine','Carre four','4123456');

 select * from agenda;

 update agenda set nombre='Pierre James'
  where nombre='pierre';
...
if object_id('medicamentos') is not null
 ...
 insert into libros (codigo,titulo,autor,editorial)
  values (1,'Maintenat tu le sais','Marie-france','le tatou');
 insert into libros (codigo,titulo,autor,editorial)
  values (2,'tout est possible en 2019','Mathou','Joyeux Journal');
 insert into libros (codigo,titulo,autor,editorial)
  values (3,'Tonique','shona vertua','le tatou');

 insert into libros (codigo,titulo,autor,editorial)
  values (2,'tout est possible en 2019','Mathou','Joyeux Journal');

 insert into libros (codigo,titulo,autor,editorial)
  values (null,'Tonique','Shona vertu','le tatou');
...
if object_id('medicamentos') is not null
 ...
 insert into alumnos (documento,nombre,domicilio)
  values('22345345','Millien Clifford','Castillo');
 insert into alumnos (documento,nombre,domicilio)
  values('23545345','Rood jerry pierre','Ensanche Aguilar 20');
 insert into alumnos (documento,nombre,domicilio)
  values('24356345','Dave Beverly','Castillo');
 insert into alumnos (documento,nombre,domicilio)
  values('25666777','Nerlyne Pierre','Castillo');
 ...
 insert into alumnos (documento,nombre,domicilio)
  values('22345345','Millien Clifford','Castillo');
 insert into alumnos (documento,nombre,domicilio)
  values('23545345','Rood jerry pierre','Ensanche Aguilar');
 insert into alumnos (documento,nombre,domicilio)
  values('24356345','Dave beverly','Castillo');
 insert into alumnos (documento,nombre,domicilio)
  values('25666777','Nerlyne Pierre','Castillo');
 ...
 insert into alumnos (documento,nombre,domicilio)
  values('22345345','Millien CLifford','Castilllo');
 insert into alumnos (documento,nombre,domicilio)
  values('23545345','Rood Jerry piere ','Ensanche Aguilar');
 insert into alumnos (documento,nombre,domicilio)
  values('24356345','Dave beverly','Castillo');
 insert into alumnos (documento,nombre,domicilio)
  values('25666777','Nerlyne Pierre','Castillo');
...
if object_id('autos') is not null
 ...
 insert into clientes
  values('2233344','Clifford','Millien','Castillo','4342345');
 insert into clientes (documento,apellido,nombre,domicilio)
  values('2333344','Rood jerry','Pierre','Castillo');
 insert into clientes
  values('2433344','Nerlyne','Pierre','Ensanche Aguilar','4558877');
 insert into clientes
  values('2533344','Beverly','Dave','Castillo','4789900');

 select *from clientes
  where apellido='Beverly';
 ...
 insert into cuentas(numero,documento,nombre,saldo)
  values('1234','25666777','Jerry Clifford',580000.60);
 insert into cuentas(numero,documento,nombre,saldo)
  values('2234','27888999','Rood jerry',-250090);
 insert into cuentas(numero,documento,nombre,saldo)
  values('3344','27888999','Rood jerry',4000.50);
 insert into cuentas(numero,documento,nombre,saldo)
  values('3346','32111222','jeffrey Millien',10000);

 select *from cuentas
  where saldo<4000;

 select numero,saldo from cuentas
  where nombre='Rood jerry';
 ...
 insert into empleados (nombre,documento,sexo,domicilio,sueldobasico,cantidadhijos)
  values ('Jean Junior','22333444','m','Castillo',500,2);
 insert into empleados (nombre,documento,sexo,domicilio,sueldobasico,cantidadhijos)
  values ('Gardy Linda','24555666','f','Castillo',850,0);
 insert into empleados (nombre,documento,sexo,domicilio,sueldobasico,cantidadhijos)
  values ('Linda Meus','27888999','m','Usann 3',10000.80,4);

 insert into empleados (nombre,documento,sexo,domicilio,sueldobasico,cantidadhijos)
  values ('Jeffrey MIlline','29000555','m','Castillo',700.888,3);

 insert into empleados (nombre,documento,sexo,domicilio,sueldobasico,cantidadhijos)
  values ('Martine luna','32444555','f','24 febrero',50000,2);
 ...
 insert into alumnos values('Pierre','Nerlyne','22222222','Castillo','10-08-1990','15/02/1972');

 insert into alumnos values('Julia','Pavoir','25555555','Castillo','03-03-1991','15/02/1972');

 insert into alumnos values('Pierre','Laury','26666666','ensanche Aguilar','03-03-91',null);

 insert into alumnos values('Dave','Beverly','27777777','Castillo','03-15-1990',null);

 select *from alumnos where fechaingreso<'1-1-91';

 select *from alumnos where fechanacimiento is null;

 insert into alumnos values('Rood','Jerry','28888888','Aguilar','03151990',null);
